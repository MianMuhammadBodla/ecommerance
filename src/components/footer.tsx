            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Get 20% off at your first shopping.
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    href="https://www.facebook.com/MianMuhammadBodlah"
                  ...
                  <a
                    href="https://twitter.com/MianMuhammadBod?t=ld1blvIo5HAgM-PNNhDqew&s=09"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="16"
                  ...
                  <a
                    href="https://www.linkedin.com/in/muhammad-bodla/"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="14"
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; All Rights Reserved My Store 
                </p>
              </div>
            </div>
          </div>
